...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时，我们竟然发现终端里npm、node命令都出现异常了。。</p><div class="custom-container warning"><p class="custom-container-title">WARNING</p><p>注意：使用nvm use切换版本时，需要使用管理员权限运行终端，否则会报错无权限访问！</p></div><p>两种解决方法：</p><ol><li><code>win+q</code> 搜索cmd，右键命令提示符选中以管理员身份运行</li><li>右键左下角win图标，点击Windows PowerShell(管理员)</li></ol><p>然后就可以愉快地切换版本了！💯</p>`,12);function p(u,b){const a=l("ExternalLinkIcon");return d(),c("div",null,[o,e("p",null,[n("进入"),e("a",m,[n("nvm下载地址"),r(a)]),n("，windows系统搜索nvm-setup.exe或zip，进行下载安装。")]),v])}const k=i(t,[["render",p],["__file","index.html.vue"]]);export{k as default};
